...
// Type: Camstar.WCF.Generator.ObjectModel.CDOMethod
...
{
  internal class CDOMethod
  {
    private readonly ModelDataSet.CDOMethodsRow mRow;

    public CDOMethod(ModelDataSet.CDOMethodsRow row)
    {
      this.mRow = row;
    }
    ...
    public int CDOMethodsId
    {
      get
      {
        return this.mRow._WCFCDOMethods_ID;
      }
    }
    ...
    public string ParmeterDescription
    {
      get
      {
        return this.mRow.ParameterDescription;
      }
    }
