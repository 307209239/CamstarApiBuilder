...
// Type: Camstar.WCF.Services.TrackTargetDeploymentMethods
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public enum TrackTargetDeploymentMethods
  {
    ...
    [Enumeration(null), EnumMember] GetNextAvailableTargetDeployment,
