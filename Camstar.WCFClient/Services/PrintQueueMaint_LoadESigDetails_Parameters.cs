...
// Type: Camstar.WCF.Services.PrintQueueMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class PrintQueueMaint_LoadESigDetails_Parameters : PrintQueueMaint_Parameters
  {
