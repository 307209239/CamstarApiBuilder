...
// Type: Camstar.WCF.Services.ResourceThruput_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class ResourceThruput_LoadESigDetails_Parameters : ResourceThruput_Parameters
  {
