...
// Type: Camstar.WCF.Services.CarrierGroupMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class CarrierGroupMaint_LoadESigDetails_Parameters : CarrierGroupMaint_Parameters
  {
