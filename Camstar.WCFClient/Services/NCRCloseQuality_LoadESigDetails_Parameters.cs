...
// Type: Camstar.WCF.Services.NCRCloseQuality_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class NCRCloseQuality_LoadESigDetails_Parameters : NCRCloseQuality_Parameters
  {
