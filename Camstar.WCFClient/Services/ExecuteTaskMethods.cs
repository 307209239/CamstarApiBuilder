...
// Type: Camstar.WCF.Services.ExecuteTaskMethods
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public enum ExecuteTaskMethods
  {
    ...
    [EnumMember, Enumeration(null)] StartTaskTimers,
    [Enumeration(null), EnumMember] ValidateTaskTimers,
