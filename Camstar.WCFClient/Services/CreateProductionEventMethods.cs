...
// Type: Camstar.WCF.Services.CreateProductionEventMethods
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public enum CreateProductionEventMethods
  {
    ...
    [Enumeration(null), EnumMember] Hold,
    [EnumMember, Enumeration(null)] Load,
    [Enumeration(null), EnumMember] LoadESigDetails,
    [EnumMember, Enumeration(null)] PrintLabels,
