...
// Type: Camstar.WCF.Services.DocAttachmentsTxn_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class DocAttachmentsTxn_LoadESigDetails_Parameters : DocAttachmentsTxn_Parameters
  {
