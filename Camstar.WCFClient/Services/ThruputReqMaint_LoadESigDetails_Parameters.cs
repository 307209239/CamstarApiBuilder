...
// Type: Camstar.WCF.Services.ThruputReqMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class ThruputReqMaint_LoadESigDetails_Parameters : ThruputReqMaint_Parameters
  {
