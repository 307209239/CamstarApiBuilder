...
// Type: Camstar.WCF.Services.ChangeMgtTxn_BuildEmptySelectionValues_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class ChangeMgtTxn_BuildEmptySelectionValues_Parameters : ChangeMgtTxn_Parameters
  {
