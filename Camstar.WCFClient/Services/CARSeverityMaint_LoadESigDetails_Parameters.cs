...
// Type: Camstar.WCF.Services.CARSeverityMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class CARSeverityMaint_LoadESigDetails_Parameters : CARSeverityMaint_Parameters
  {
