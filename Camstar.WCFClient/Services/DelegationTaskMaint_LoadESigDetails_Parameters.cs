...
// Type: Camstar.WCF.Services.DelegationTaskMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class DelegationTaskMaint_LoadESigDetails_Parameters : DelegationTaskMaint_Parameters
  {
