...
// Type: Camstar.WCF.Services.CompleteMaintenanceMethods
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public enum CompleteMaintenanceMethods
  {
    [Enumeration(null), EnumMember] CreateParametricData,
    [EnumMember, Enumeration(null)] CreateServiceDetail,
    [EnumMember, Enumeration(null)] GetActions,
    [Enumeration(null), EnumMember] GetDataPoints,
    [Enumeration(null), EnumMember] GetESigReqFromMaintReq,
