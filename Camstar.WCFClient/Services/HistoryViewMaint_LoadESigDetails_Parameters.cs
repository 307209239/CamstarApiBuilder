...
// Type: Camstar.WCF.Services.HistoryViewMaint_LoadESigDetails_Parameters
...
namespace Camstar.WCF.Services
{
  ...
  [Serializable]
  public class HistoryViewMaint_LoadESigDetails_Parameters : HistoryViewMaint_Parameters
  {
