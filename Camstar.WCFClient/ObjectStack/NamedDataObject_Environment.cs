...
// Type: Camstar.WCF.ObjectStack.NamedDataObject_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class NamedDataObject_Environment : BaseObject_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_ESigHistoryDetails")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_WhereUsed")]
    protected Environment _WhereUsed;
    [Metadata("DisplayName", "", false, false, true, "String", 1049720, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_DisplayName")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_ModelingInstanceLocks")]
    protected Environment _ModelingInstanceLocks;
    [Metadata("FilterTags", "", false, false, true, "String", 16778956, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_FilterTags")]
    protected Environment _FilterTags;
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_AssociatedPackages")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_InstanceLocked")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_Description")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_ChangeHistory")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_IconId")]
    protected Environment _IconId;
    [Metadata("Notes/Comments", "", false, false, true, "String", 1048624, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_Notes")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_Name")]
    protected Environment _Name;
    [DataMember(EmitDefaultValue = false, Name = "NamedDataObject_Environment_IsFrozen")]
