...
// Type: Camstar.WCF.ObjectStack.RegulatoryReportHistoryDetail_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RegulatoryReportHistoryDetail_Info : ServiceHistoryDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_AttachmentRef")]
    protected Info _AttachmentRef;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_ExportImportKey")]
    protected new Info _ExportImportKey;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_Comments")]
    protected Info _Comments;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_RegulatoryAgency")]
    protected Info _RegulatoryAgency;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_RegulatoryReportType")]
    protected Info _RegulatoryReportType;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_SubmissionDate")]
    protected Info _SubmissionDate;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_DueDate")]
    protected Info _DueDate;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_DueDateGMT")]
    protected Info _DueDateGMT;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_CreationDateGMT")]
    protected Info _CreationDateGMT;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_CreationDate")]
    protected Info _CreationDate;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_ReportNumber")]
    protected Info _ReportNumber;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_SubmissionRequired")]
    protected Info _SubmissionRequired;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_SubmissionDateGMT")]
    protected Info _SubmissionDateGMT;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_HistoryId")]
    protected new Info _HistoryId;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_SubmittedBy")]
    protected Info _SubmittedBy;
    [DataMember(EmitDefaultValue = false, Name = "RegulatoryReportHistoryDetail_Info_CreatedBy")]
