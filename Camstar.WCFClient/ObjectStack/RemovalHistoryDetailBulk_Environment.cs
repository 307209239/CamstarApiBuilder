...
// Type: Camstar.WCF.ObjectStack.RemovalHistoryDetailBulk_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalHistoryDetailBulk_Environment : RemovalHistoryDetail_Environment
  {
    [Metadata("Records the actual values issued to meet the BOM line item requirements for issue type bulk.", "IssueActualsHistoryBulk", false, false, true, "SubentityRef", 1049765, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailBulk_Environment_IssueActualsHistory")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailBulk_Environment_OpenClosedContainer")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailBulk_Environment_DestinationContainer")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailBulk_Environment_DestinationLocation")]
