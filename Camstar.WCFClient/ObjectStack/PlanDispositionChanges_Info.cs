...
// Type: Camstar.WCF.ObjectStack.PlanDispositionChanges_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class PlanDispositionChanges_Info : PlanChanges_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Info_EventLots")]
    protected Info _EventLots;
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Info_AvailableLots")]
    protected AvailableLotDetail_Info _AvailableLots;
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Info_DiscoveryArea")]
