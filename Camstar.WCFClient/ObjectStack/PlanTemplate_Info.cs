...
// Type: Camstar.WCF.ObjectStack.PlanTemplate_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class PlanTemplate_Info : ProcessObjectTemplate_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AssigneeRole")]
    protected new Info _AssigneeRole;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Description")]
    protected new Info _Description;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Organizations")]
    protected new Info _Organizations;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_onCompleteRules")]
    protected BusinessRuleData_Info _onCompleteRules;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_onStartRules")]
    protected BusinessRuleData_Info _onStartRules;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_FilterTags")]
    protected new Info _FilterTags;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Checklist")]
    protected new Checklist_Info _Checklist;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_ModelingInstanceLocks")]
    protected new Info _ModelingInstanceLocks;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_ApprovalSheets")]
    protected ApprovalSheet_Info _ApprovalSheets;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AllowReassignment")]
    protected new Info _AllowReassignment;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_CompleteWithinUOM")]
    protected new Info _CompleteWithinUOM;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AssigneeOption")]
    protected new Info _AssigneeOption;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_InstanceLocked")]
    protected new Info _InstanceLocked;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_CompleteWithinQty")]
    protected new Info _CompleteWithinQty;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AutoStart")]
    protected new Info _AutoStart;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_DefaultAssigneeInfo")]
    protected new Info _DefaultAssigneeInfo;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_IsRequired")]
    protected new Info _IsRequired;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AutoComplete")]
    protected new Info _AutoComplete;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_ApprovalRequired")]
    protected new Info _ApprovalRequired;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_AssociatedPackages")]
    protected new Info _AssociatedPackages;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Assignee")]
    protected new Info _Assignee;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_ChangeHistory")]
    protected new ChangeHistory_Info _ChangeHistory;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_DocumentSet")]
    protected new Info _DocumentSet;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Name")]
    protected new Info _Name;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Notes")]
    protected new Info _Notes;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_IsFrozen")]
    protected new Info _IsFrozen;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_IconId")]
    protected new Info _IconId;
    [DataMember(EmitDefaultValue = false, Name = "PlanTemplate_Info_Status")]
