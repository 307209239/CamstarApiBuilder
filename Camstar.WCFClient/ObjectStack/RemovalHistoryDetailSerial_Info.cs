...
// Type: Camstar.WCF.ObjectStack.RemovalHistoryDetailSerial_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalHistoryDetailSerial_Info : RemovalHistoryDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailSerial_Info_IssueActualsHistory")]
    protected new Info _IssueActualsHistory;
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailSerial_Info_DestinationContainer")]
    protected Info _DestinationContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailSerial_Info_OpenClosedContainer")]
    protected Info _OpenClosedContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalHistoryDetailSerial_Info_DestinationLocation")]
