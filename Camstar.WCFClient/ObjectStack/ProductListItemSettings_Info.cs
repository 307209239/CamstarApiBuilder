...
// Type: Camstar.WCF.ObjectStack.ProductListItemSettings_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ProductListItemSettings_Info : MaterialListItemSettings_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "ProductListItemSettings_Info_TypeName")]
    protected new Info _TypeName;
    [DataMember(EmitDefaultValue = false, Name = "ProductListItemSettings_Info_ParentName")]
    protected new Info _ParentName;
    [DataMember(EmitDefaultValue = false, Name = "ProductListItemSettings_Info_PhantomQueryName")]
    protected new Info _PhantomQueryName;
    [DataMember(EmitDefaultValue = false, Name = "ProductListItemSettings_Info_QueryName")]
