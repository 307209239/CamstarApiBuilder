...
// Type: Camstar.WCF.ObjectStack.ActivityTemplate_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ActivityTemplate_Environment : ProcessObjectTemplate_Environment
  {
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_DataCollectionDef")]
    protected Environment _DataCollectionDef;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Description")]
    [Metadata("Instruction", "", false, false, true, "String", 1051642, false, false, false, null)]
    protected new Environment _Description;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AssigneeRole")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Organizations")]
    protected new Environment _Organizations;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AllowReassignment")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Checklist")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_ModelingInstanceLocks")]
    protected new Environment _ModelingInstanceLocks;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_FilterTags")]
    [Metadata("FilterTags", "", false, false, true, "String", 16778956, false, false, false, null)]
    protected new Environment _FilterTags;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AssigneeOption")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_CompleteWithinUOM")]
    protected new Environment _CompleteWithinUOM;
    [Metadata("Business Rule Data", "BusinessRuleData", false, false, true, "BusinessRuleData", 1051737, false, true, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_onExecuteRules")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AssociatedPackages")]
    protected new Environment _AssociatedPackages;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AutoExecute")]
    [Metadata("Generic Boolean", "", false, false, true, "Boolean", 1051378, false, false, false, "0")]
    protected Environment _AutoExecute;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_ApprovalRequired")]
    [Metadata("Generic Boolean", "", false, false, true, "Boolean", 1051371, false, false, false, "0")]
    protected new Environment _ApprovalRequired;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_CompleteWithinQty")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AutoComplete")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_InstanceLocked")]
    protected new Environment _InstanceLocked;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_IsRequired")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_DefaultAssigneeInfo")]
    protected new Environment _DefaultAssigneeInfo;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_AutoStart")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_IconId")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Assignee")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_DocumentSet")]
    protected new Environment _DocumentSet;
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_IsFrozen")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_ChangeHistory")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Status")]
    protected new Environment _Status;
    [Metadata("Notes/Comments", "", false, false, true, "String", 1048624, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Notes")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "ActivityTemplate_Environment_Name")]
