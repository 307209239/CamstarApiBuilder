...
// Type: Camstar.WCF.ObjectStack.PlanDispositionChanges_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class PlanDispositionChanges_Environment : PlanChanges_Environment
  {
    [Metadata("Identifies a suspect Lot for an Event.", "EventLot", false, false, false, "SubentityRef", 1051071, false, true, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Environment_EventLots")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Environment_AvailableLots")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PlanDispositionChanges_Environment_DiscoveryArea")]
