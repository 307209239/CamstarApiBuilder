...
// Type: Camstar.WCF.ObjectStack.RemovalDetailStock_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalDetailStock_Info : RemovalDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailStock_Info_IssueControl")]
    protected new Info _IssueControl;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailStock_Info_IssueActualHistory")]
    protected new Info _IssueActualHistory;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailStock_Info_DestinationStockPoint")]
