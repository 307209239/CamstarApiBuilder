...
// Type: Camstar.WCF.ObjectStack.RecipeChanges_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RecipeChanges_Environment : DocumentChanges_Environment
  {
    [Metadata("A sub class of DocumentBase defines recipe.", "RecipeBase", false, false, false, "RevisionedObjectRef", 1048857, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "RecipeChanges_Environment_Base")]
    protected new Environment _Base;
    [DataMember(EmitDefaultValue = false, Name = "RecipeChanges_Environment_ObjectToChange")]
    ...
    [Metadata("Unique name for this instance", "", false, true, false, "String", 1050229, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "RecipeChanges_Environment_Name")]
