...
// Type: Camstar.WCF.ObjectStack.RemovalDetailLotStock_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalDetailLotStock_Info : RemovalDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailLotStock_Info_IssueActualHistory")]
    protected new Info _IssueActualHistory;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailLotStock_Info_IssueControl")]
    protected new Info _IssueControl;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailLotStock_Info_DestinationLot")]
    protected Info _DestinationLot;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailLotStock_Info_DestinationStockPoint")]
