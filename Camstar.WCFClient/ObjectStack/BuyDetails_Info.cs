...
// Type: Camstar.WCF.ObjectStack.BuyDetails_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class BuyDetails_Info : ChangeQtyDetails_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_Qty2")]
    protected new Info _Qty2;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_ReasonCode")]
    protected new Info _ReasonCode;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_ChangeQtyType")]
    protected new Info _ChangeQtyType;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_AdjustThruput")]
    protected new Info _AdjustThruput;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_TypeSortOrder")]
    protected new Info _TypeSortOrder;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_Qty")]
    protected new Info _Qty;
    [DataMember(EmitDefaultValue = false, Name = "BuyDetails_Info_ChargeToStep")]
