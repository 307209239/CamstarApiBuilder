...
// Type: Camstar.WCF.ObjectStack.CompleteActivityHistory_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [KnownType(typeof (CompleteActivityInvHistory_Environment))]
  [KnownType(typeof (CompleteActivityDispHistory_Environment))]
  [Serializable]
  public class CompleteActivityHistory_Environment : ProcessObjectTxnHistory_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_ExportImportKey")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_QualityObject")]
    protected new Environment _QualityObject;
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_HistoryDetails")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_ProcessObject")]
    protected new Environment _ProcessObject;
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_HistoryId")]
    [Metadata("BaseObject", "BaseObject", false, false, true, "BaseObjectRef", 1049097, false, false, false, null)]
    protected new Environment _HistoryId;
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_Employee")]
    [Metadata("An Employee is a person that can login to InSite, perform transactions, and/or be credited with work.  The Employees must have a Windows NT account. Once defined, the user will then appear in the user list within the Modeler Security window. In this way the Employee definition feeds directly into the Modeler Security.\r\n\r\nThe Employee definitions also allow for other options for each user such as the factory associate with the user and the language that will be used.  Persons that will get credited with work by being entered in the employee field on a transaction, must exist as InSite employees, but are not required to exist as Windows user accounts.", "Employee", false, false, true, "NamedObjectRef", 1051687, false, false, false, null)]
    protected new Environment _Employee;
    [Metadata("Notes/Comments", "", false, false, true, "String", 1048866, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "CompleteActivityHistory_Environment_CompletionComments")]
