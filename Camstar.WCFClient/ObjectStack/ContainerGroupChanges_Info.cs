...
// Type: Camstar.WCF.ObjectStack.ContainerGroupChanges_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ContainerGroupChanges_Info : ObjectGroupChanges_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_ObjectToChange")]
    protected new Info _ObjectToChange;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_NewGroup")]
    protected new Info _NewGroup;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_Groups")]
    protected new Info _Groups;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_NewEntry")]
    protected new Info _NewEntry;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_Entries")]
    protected new Info _Entries;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_ResolvedEntries")]
    protected new Info _ResolvedEntries;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_EntryType")]
    protected new Info _EntryType;
    [DataMember(EmitDefaultValue = false, Name = "ContainerGroupChanges_Info_Name")]
