...
// Type: Camstar.WCF.ObjectStack.CompleteProcessObjectHistory_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class CompleteProcessObjectHistory_Environment : ProcessObjectTxnHistory_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_QualityObject")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_ExportImportKey")]
    [Metadata("Hexadecimal representation of GUID ( e.g. BDE4B634-153E-4A31-A453-EEA85FE80532)", "", false, false, true, "String", 0, false, false, false, null)]
    protected new Environment _ExportImportKey;
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_HistoryDetails")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_ProcessObject")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_HistoryId")]
    protected new Environment _HistoryId;
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_CompletionComments")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "CompleteProcessObjectHistory_Environment_Employee")]
