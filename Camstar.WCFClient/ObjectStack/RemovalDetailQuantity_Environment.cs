...
// Type: Camstar.WCF.ObjectStack.RemovalDetailQuantity_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalDetailQuantity_Environment : RemovalDetail_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailQuantity_Environment_IssueControl")]
    [Metadata("1 - Container is tracked in InSite at the serial level\r\n2 - Container is tracked in InSite at the bulk level\r\n3 - Container is not tracked in InSite ... quantity and lot is recorded\r\n4 - non lot controlled ( floor stock ) location is recorded no container\r\n5 - recording quantities but not container or location\r\n6 - issue quantities are displayed but not recorded\r\n", "IssueControlEnum", false, false, false, "Integer", 1049463, false, false, true, "5")]
    protected new Environment _IssueControl;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailQuantity_Environment_IssueActualHistory")]
    [Metadata("Records the actual values issued to meet the BOM line item requirements for issue type quantity only.", "IssueActualsHistoryQuantity", false, false, false, "SubentityRef", 1049872, false, false, false, null)]
