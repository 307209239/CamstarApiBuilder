...
// Type: Camstar.WCF.ObjectStack.Close_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class Close_Info : ContainerStatusChange_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "Close_Info_IncludeChildren")]
