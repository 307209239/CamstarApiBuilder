...
// Type: Camstar.WCF.ObjectStack.IssueActualsHistorySerial_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class IssueActualsHistorySerial_Info : IssueActualsHistory_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "IssueActualsHistorySerial_Info_FromBatch")]
    protected Info _FromBatch;
    [DataMember(EmitDefaultValue = false, Name = "IssueActualsHistorySerial_Info_FromCarrier")]
    protected Info _FromCarrier;
    [DataMember(EmitDefaultValue = false, Name = "IssueActualsHistorySerial_Info_FromContainer")]
    protected Info _FromContainer;
    [DataMember(EmitDefaultValue = false, Name = "IssueActualsHistorySerial_Info_IssuedFrom")]
    protected new Info _IssuedFrom;
    [DataMember(EmitDefaultValue = false, Name = "IssueActualsHistorySerial_Info_FromLocation")]
