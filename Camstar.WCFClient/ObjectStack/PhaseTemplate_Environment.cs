...
// Type: Camstar.WCF.ObjectStack.PhaseTemplate_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class PhaseTemplate_Environment : ProcessObjectTemplate_Environment
  {
    [Metadata("Instruction", "", false, false, true, "String", 1051642, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Description")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AssigneeRole")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Organizations")]
    protected new Environment _Organizations;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_CompleteWithinUOM")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_onStartRules")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_onCompleteRules")]
    protected BusinessRuleData_Environment _onCompleteRules;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Checklist")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_FilterTags")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Details")]
    protected new ProcessObject_Environment _Details;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AllowReassignment")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_ModelingInstanceLocks")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_ApprovalSheets")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AssigneeOption")]
    protected new Environment _AssigneeOption;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_IsRequired")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AssociatedPackages")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AutoStart")]
    protected new Environment _AutoStart;
    [Metadata("Generic Integer", "", false, false, false, "Integer", 1051407, false, false, false, null)]
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_CompleteWithinQty")]
    protected new Environment _CompleteWithinQty;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_DefaultAssigneeInfo")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_InstanceLocked")]
    protected new Environment _InstanceLocked;
    [Metadata("Generic Boolean", "", false, false, true, "Boolean", 1051371, false, false, false, "0")]
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_ApprovalRequired")]
    protected new Environment _ApprovalRequired;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_AutoComplete")]
    [Metadata("Generic Boolean", "", false, false, true, "Boolean", 1051785, false, false, false, "0")]
    protected new Environment _AutoComplete;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_IconId")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Assignee")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Name")]
    protected new Environment _Name;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_DocumentSet")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Notes")]
    protected new Environment _Notes;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_ChangeHistory")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_IsFrozen")]
    protected new Environment _IsFrozen;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplate_Environment_Status")]
