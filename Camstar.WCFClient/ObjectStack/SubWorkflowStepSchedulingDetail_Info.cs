...
// Type: Camstar.WCF.ObjectStack.SubWorkflowStepSchedulingDetail_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class SubWorkflowStepSchedulingDetail_Info : StepSchedulingDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_RunRateOption")]
    protected new Info _RunRateOption;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_ForwardYield")]
    protected new Info _ForwardYield;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_DurationPerUnit")]
    protected new Info _DurationPerUnit;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_SetupTime")]
    protected new Info _SetupTime;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_Yield")]
    protected new Info _Yield;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_UnitsPerHour")]
    protected new Info _UnitsPerHour;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_StdBatchSize")]
    protected new Info _StdBatchSize;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_NormalCycleTime")]
    protected new Info _NormalCycleTime;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_ForwardCycleTime")]
    protected new Info _ForwardCycleTime;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Info_FastCycleTime")]
