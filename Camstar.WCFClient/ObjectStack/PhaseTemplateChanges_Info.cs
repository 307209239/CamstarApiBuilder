...
// Type: Camstar.WCF.ObjectStack.PhaseTemplateChanges_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class PhaseTemplateChanges_Info : ProcessObjectTmpltChanges_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_ExecutionContextType")]
    protected new Info _ExecutionContextType;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_Details")]
    protected new ProcessObjectChanges_Info _Details;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_onCompleteRules")]
    protected BusinessRuleDataChanges_Info _onCompleteRules;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_ObjectToChange")]
    protected new Info _ObjectToChange;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_ApprovalSheets")]
    protected ApprovalSheetChanges_Info _ApprovalSheets;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_onStartRules")]
    protected BusinessRuleDataChanges_Info _onStartRules;
    [DataMember(EmitDefaultValue = false, Name = "PhaseTemplateChanges_Info_Name")]
