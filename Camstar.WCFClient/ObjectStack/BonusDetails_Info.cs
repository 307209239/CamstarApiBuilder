...
// Type: Camstar.WCF.ObjectStack.BonusDetails_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class BonusDetails_Info : ChangeQtyDetails_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_Qty2")]
    protected new Info _Qty2;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_ReasonCode")]
    protected new Info _ReasonCode;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_CountsAgainstProduction")]
    protected new Info _CountsAgainstProduction;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_TypeSortOrder")]
    protected new Info _TypeSortOrder;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_ChangeQtyType")]
    protected new Info _ChangeQtyType;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_AdjustThruput")]
    protected new Info _AdjustThruput;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_ChargeToStep")]
    protected new Info _ChargeToStep;
    [DataMember(EmitDefaultValue = false, Name = "BonusDetails_Info_Qty")]
