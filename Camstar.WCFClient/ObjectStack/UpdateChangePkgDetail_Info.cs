...
// Type: Camstar.WCF.ObjectStack.UpdateChangePkgDetail_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class UpdateChangePkgDetail_Info : ChangePackageDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "UpdateChangePkgDetail_Info_TargetSystems")]
    protected new TargetSystemDetail_Info _TargetSystems;
    [DataMember(EmitDefaultValue = false, Name = "UpdateChangePkgDetail_Info_PreReqChangePkgs")]
    protected PackageInquiryDetail_Info _PreReqChangePkgs;
    [DataMember(EmitDefaultValue = false, Name = "UpdateChangePkgDetail_Info_SourceSystem")]
