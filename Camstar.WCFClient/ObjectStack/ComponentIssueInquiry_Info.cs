...
// Type: Camstar.WCF.ObjectStack.ComponentIssueInquiry_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ComponentIssueInquiry_Info : Inquiry_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_Qty2")]
    protected Info _Qty2;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_IssueDetails")]
    protected IssueDetails_Info _IssueDetails;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_UOM")]
    protected Info _UOM;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_BOMLineItem")]
    protected Info _BOMLineItem;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_UOM2")]
    protected Info _UOM2;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_ParentContainer")]
    protected Info _ParentContainer;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_ObjectName")]
    protected Info _ObjectName;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_Container")]
    protected Info _Container;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_Qty")]
    protected Info _Qty;
    [DataMember(EmitDefaultValue = false, Name = "ComponentIssueInquiry_Info_Product")]
