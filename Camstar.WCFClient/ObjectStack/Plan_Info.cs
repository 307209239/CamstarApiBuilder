...
// Type: Camstar.WCF.ObjectStack.Plan_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [KnownType(typeof (PlanDisposition_Info))]
  [Serializable]
  public class Plan_Info : ProcessObject_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AssigneeRole")]
    protected new Info _AssigneeRole;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Description")]
    protected new Info _Description;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_ExportImportKey")]
    protected new Info _ExportImportKey;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_OwnerRole")]
    protected new Info _OwnerRole;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_ESigHistoryDetails")]
    protected new Info _ESigHistoryDetails;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_ReassignmentComments")]
    protected new Info _ReassignmentComments;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Attachments")]
    protected new DocAttachments_Info _Attachments;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AssigneeOption")]
    protected new Info _AssigneeOption;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Stage")]
    protected new Info _Stage;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Details")]
    protected new ProcessObject_Info _Details;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_onStartRules")]
    protected BusinessRuleData_Info _onStartRules;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Organization")]
    protected new Info _Organization;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompleteWithinUOM")]
    protected Info _CompleteWithinUOM;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastStage")]
    protected new Info _LastStage;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_OutstandingDetailStatus")]
    protected new Info _OutstandingDetailStatus;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastApprovalRouted")]
    protected Info _LastApprovalRouted;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_ApprovalSheets")]
    protected ApprovalSheet_Info _ApprovalSheets;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_DataPointCollection")]
    protected new DataPointCollection_Info _DataPointCollection;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_onCompleteRules")]
    protected BusinessRuleData_Info _onCompleteRules;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Checklist")]
    protected new Checklist_Info _Checklist;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Prerequisites")]
    protected Plan_Info _Prerequisites;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AllowReassignment")]
    protected new Info _AllowReassignment;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AutoStart")]
    protected new Info _AutoStart;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompleteWithinQty")]
    protected Info _CompleteWithinQty;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastCompletedOn")]
    protected new Info _LastCompletedOn;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastCompletedOnGMT")]
    protected new Info _LastCompletedOnGMT;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Sequence")]
    protected new Info _Sequence;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastDesignatedOnGMT")]
    protected new Info _LastDesignatedOnGMT;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AutoComplete")]
    protected new Info _AutoComplete;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastDesignatedOn")]
    protected new Info _LastDesignatedOn;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_AutoCompleteFailure")]
    protected new Info _AutoCompleteFailure;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompleteBy")]
    protected Info _CompleteBy;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_DefaultAssigneeInfo")]
    protected new Info _DefaultAssigneeInfo;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_FirstRoutedOnGMT")]
    protected new Info _FirstRoutedOnGMT;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_FirstRoutedOn")]
    protected new Info _FirstRoutedOn;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompleteByGMT")]
    protected Info _CompleteByGMT;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_IsRequired")]
    protected new Info _IsRequired;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_LastCompletedBy")]
    protected new Info _LastCompletedBy;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_ChangeHistory")]
    protected new ChangeHistory_Info _ChangeHistory;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Notes")]
    protected new Info _Notes;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompleteWithin")]
    protected Info _CompleteWithin;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_CompletionComments")]
    protected new Info _CompletionComments;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_IsFrozen")]
    protected new Info _IsFrozen;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_DocumentSet")]
    protected new Info _DocumentSet;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Owner")]
    protected new Info _Owner;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Name")]
    protected new Info _Name;
    [DataMember(EmitDefaultValue = false, Name = "Plan_Info_Assignee")]
    ...
    public Plan_Info Prerequisites
    {
      [param: In] set
      {
      ...
      get
      {
        return (Plan_Info) this.PropertyGet(nameof (Prerequisites));
      }
    }
