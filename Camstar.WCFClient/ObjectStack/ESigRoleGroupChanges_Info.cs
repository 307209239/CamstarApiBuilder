...
// Type: Camstar.WCF.ObjectStack.ESigRoleGroupChanges_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ESigRoleGroupChanges_Info : NamedObjectGroupChanges_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_ResolvedEntries")]
    protected new Info _ResolvedEntries;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_Entries")]
    protected new Info _Entries;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_NewEntry")]
    protected new Info _NewEntry;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_Groups")]
    protected new Info _Groups;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_ObjectToChange")]
    protected new Info _ObjectToChange;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_NewGroup")]
    protected new Info _NewGroup;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_EntryType")]
    protected new Info _EntryType;
    [DataMember(EmitDefaultValue = false, Name = "ESigRoleGroupChanges_Info_Name")]
