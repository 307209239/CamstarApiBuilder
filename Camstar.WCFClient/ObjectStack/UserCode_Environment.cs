...
// Type: Camstar.WCF.ObjectStack.UserCode_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class UserCode_Environment : NamedDataObject_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_WhereUsed")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_DisplayName")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_ModelingInstanceLocks")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_FilterTags")]
    protected new Environment _FilterTags;
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_AssociatedPackages")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_InstanceLocked")]
    protected new Environment _InstanceLocked;
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_ChangeHistory")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_IconId")]
    protected new Environment _IconId;
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_Description")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_IsFrozen")]
    protected new Environment _IsFrozen;
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_Notes")]
    [Metadata("Notes/Comments", "", false, false, true, "String", 1048624, false, false, false, null)]
    protected new Environment _Notes;
    [DataMember(EmitDefaultValue = false, Name = "UserCode_Environment_Name")]
    [Metadata("Unique name for this instance", "", false, false, true, "String", 1050098, false, false, false, null)]
