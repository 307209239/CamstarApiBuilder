...
// Type: Camstar.WCF.ObjectStack.RemovalDetailSerial_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class RemovalDetailSerial_Info : RemovalDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_IssueActualHistory")]
    protected new Info _IssueActualHistory;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_Qty2Removed")]
    protected new Info _Qty2Removed;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_IssueControl")]
    protected new Info _IssueControl;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_DestinationContainer")]
    protected Info _DestinationContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_NewParentContainer")]
    protected Info _NewParentContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_OpenClosedContainer")]
    protected Info _OpenClosedContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_ScrapContainer")]
    protected Info _ScrapContainer;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_DestinationLocation")]
    protected Info _DestinationLocation;
    [DataMember(EmitDefaultValue = false, Name = "RemovalDetailSerial_Info_QtyRemoved")]
    protected new Info _QtyRemoved;
    ...
    public Info NewParentContainer
    {
      [param: In] set
      {
      ...
      get
      {
        return (Info) this.PropertyGet(nameof (NewParentContainer));
      }
    }
