...
// Type: Camstar.WCF.ObjectStack.ReportSourceHistoryDetail_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class ReportSourceHistoryDetail_Info : OtherCheckBoxFieldHistDetail_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_Literature")]
    protected Info _Literature;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_UserFacility")]
    protected Info _UserFacility;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_HealthProfessional")]
    protected Info _HealthProfessional;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_Distributor")]
    protected Info _Distributor;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_Foreign")]
    protected Info _Foreign;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_Consumer")]
    protected Info _Consumer;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_Study")]
    protected Info _Study;
    [DataMember(EmitDefaultValue = false, Name = "ReportSourceHistoryDetail_Info_CompanyRepresentative")]
