...
// Type: Camstar.WCF.ObjectStack.SellDetails_Info
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class SellDetails_Info : ChangeQtyDetails_Info
  {
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_ReasonCode")]
    protected new Info _ReasonCode;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_Qty2")]
    protected new Info _Qty2;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_QtyMultiplier")]
    protected new Info _QtyMultiplier;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_TypeSortOrder")]
    protected new Info _TypeSortOrder;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_AdjustThruput")]
    protected new Info _AdjustThruput;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_ChangeQtyType")]
    protected new Info _ChangeQtyType;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_Container")]
    protected new Info _Container;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_RecordAllQty")]
    protected new Info _RecordAllQty;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_ChargeToStep")]
    protected new Info _ChargeToStep;
    [DataMember(EmitDefaultValue = false, Name = "SellDetails_Info_Qty")]
