...
// Type: Camstar.WCF.ObjectStack.SubWorkflowStepSchedulingDetail_Environment
...
namespace Camstar.WCF.ObjectStack
{
  ...
  [Serializable]
  public class SubWorkflowStepSchedulingDetail_Environment : StepSchedulingDetail_Environment
  {
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_RunRateOption")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_ForwardYield")]
    protected new Environment _ForwardYield;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_DurationPerUnit")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_SetupTime")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_Yield")]
    protected new Environment _Yield;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_UnitsPerHour")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_StdBatchSize")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_NormalCycleTime")]
    ...
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_ForwardCycleTime")]
    protected new Environment _ForwardCycleTime;
    [DataMember(EmitDefaultValue = false, Name = "SubWorkflowStepSchedulingDetail_Environment_FastCycleTime")]
