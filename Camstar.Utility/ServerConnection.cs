...
// Type: Camstar.Utility.ServerConnection
...
namespace Camstar.Utility
{
  public class ServerConnection
  {
    ...
    public virtual int SendTimeout
    {
      ...
      set
      {
        this.Settings.SendTimeout = value;
      }
    }
    ...
    public virtual int ReceiveTimeout
    {
      get
      {
        return this.Settings.ReceiveTimeout;
      }
      set
      {
        this.Settings.ReceiveTimeout = value;
      }
    }
    ...
    public virtual string XMLLogPath
    {
      get
      {
        return this.Settings.XMLLogPath;
      }
      set
      {
        this.Settings.XMLLogPath = value;
      }
    }
    ...
    public virtual bool LogXML
    {
      get
      {
        return this.Settings.LogXml;
      }
      set
      {
        this.Settings.LogXml = value;
      }
    }
    ...
    public virtual string ConfigurationFile
    {
      get
      {
        return ServerConnectionSettings.DefaultConfigurationFile;
      }
      set
      {
        if (StringUtil.IsEmptyString(value))
    ...
    {
      return this.Submit(host, port, (string) null, (string) null, this.Settings.LogXml, (string) null);
    }

    public virtual string Submit(string host, int port, string inboundXML)
    {
      return this.Submit(host, port, inboundXML, (string) null, this.Settings.LogXml, (string) null);
    }
    ...
    {
      return this.Submit(host, -1, (string) null, (string) null, this.Settings.LogXml, (string) null);
    }

    public virtual string Submit(string host, string inboundXML)
    {
      return this.Submit(host, -1, inboundXML, (string) null, this.Settings.LogXml, (string) null);
    }
    ...
    {
      return this.Submit(host, -1, inboundXML, inboundXMLFilePath, this.Settings.LogXml, (string) null);
    }
    ...
    {
      this.LogEntry(message, EventLogEntryType.Information);
    }
    ...
    protected virtual string GetLogFile(string suffix)
    {
      ...
      try
      {
        stringBuilder.Append(Thread.CurrentContext.ContextID.ToString("d2"));
      }
      catch (Exception ex)
      {
    ...
    {
      return this.Settings.IgnoreInvalidCert || this.IsHostLocalMachine(this.Settings.Host) || errors == SslPolicyErrors.None;
    }
